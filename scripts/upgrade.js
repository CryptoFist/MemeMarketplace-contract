 ...
 */
 ...
 const { deploy, deployProxy, getAt, upgradeProxy } = require('../scripts/utils');
 ...
 async function main() {
    ...
    this.revNFT = await getAt('RevNFT', '0x966dC3Fd635f7BE39Ab8162207Fd56A6e884D148');
    this.revFactory = await upgradeProxy('RevFactory', '0x0f0782765FbC636Dc020914E5B7698156904ca25');
    this.saleNFT = await upgradeProxy('RevSale', '0x6A439F9a4C3B0a5349108bC29c8b6FD3E85e2567');
    this.auction = await upgradeProxy('RevAuction', '0x9D193AFc23EEC7EFB179807B41ec090a5965F8DA');
    this.marketPlace = await upgradeProxy('MarketPlace', '0xF45831366eD2D8E963C8D5671d85BE3b9D9ce0F0');
    this.marketPlaceRouter = await upgradeProxy('MarketPlaceRouter', '0x20C57729FAFE3F5b0c7c801A38fe43A475dFAB71');
